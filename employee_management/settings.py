...
SECRET_KEY = '_cuu_crn)^+z_pdmw%4#g6!(3oi5l@=1w_w-1)#+chp#^ev5yt'
...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-t*(78+y%zgm3*0wyj)pw8v3xqdo+*&euu)6domndz^jwev^3i7'
...
'DEFAULT_PARSER_CLASSES': [
        ...
        'rest_framework.parsers.MultiPartParser', # parse from-data packe
